...
mixin _$SpecialModel {
 ...
 String get id; String get venueId; String get venueName; String get title; String get description; String get imageUrl; DateTime get postedAt; DateTime? get startTime; DateTime? get endTime; double? get latitude; double? get longitude; List<String> get tags; String get recurrence;// Deprecated, use recurrenceRule
 RecurrenceRule? get recurrenceRule; bool get isTemplate; String? get templateId; bool get isCancelled; DateTime? get archivedAt; bool get isStarred; DateTime? get unstarredAt; List<String> get reactionUserIds; List<String> get interestedUserIds; int get commentCount; String get authorType; String? get authorId; String? get postedByUid; String? get latestComment;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,venueId,venueName,title,description,imageUrl,postedAt,startTime,endTime,latitude,longitude,const DeepCollectionEquality().hash(tags),recurrence,recurrenceRule,isTemplate,templateId,isCancelled,archivedAt,isStarred,unstarredAt,const DeepCollectionEquality().hash(reactionUserIds),const DeepCollectionEquality().hash(interestedUserIds),commentCount,authorType,authorId,postedByUid,latestComment]);

@override
String toString() {
  return 'SpecialModel(id: $id, venueId: $venueId, venueName: $venueName, title: $title, description: $description, imageUrl: $imageUrl, postedAt: $postedAt, startTime: $startTime, endTime: $endTime, latitude: $latitude, longitude: $longitude, tags: $tags, recurrence: $recurrence, recurrenceRule: $recurrenceRule, isTemplate: $isTemplate, templateId: $templateId, isCancelled: $isCancelled, archivedAt: $archivedAt, isStarred: $isStarred, unstarredAt: $unstarredAt, reactionUserIds: $reactionUserIds, interestedUserIds: $interestedUserIds, commentCount: $commentCount, authorType: $authorType, authorId: $authorId, postedByUid: $postedByUid, latestComment: $latestComment)';
}
...
@useResult
$Res call({
 String id, String venueId, String venueName, String title, String description, String imageUrl, DateTime postedAt, DateTime? startTime, DateTime? endTime, double? latitude, double? longitude, List<String> tags, String recurrence, RecurrenceRule? recurrenceRule, bool isTemplate, String? templateId, bool isCancelled, DateTime? archivedAt, bool isStarred, DateTime? unstarredAt, List<String> reactionUserIds, List<String> interestedUserIds, int commentCount, String authorType, String? authorId, String? postedByUid, String? latestComment
});
...
/// Create a copy of SpecialModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? venueId = null,Object? venueName = null,Object? title = null,Object? description = null,Object? imageUrl = null,Object? postedAt = null,Object? startTime = freezed,Object? endTime = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? tags = null,Object? recurrence = null,Object? recurrenceRule = freezed,Object? isTemplate = null,Object? templateId = freezed,Object? isCancelled = null,Object? archivedAt = freezed,Object? isStarred = null,Object? unstarredAt = freezed,Object? reactionUserIds = null,Object? interestedUserIds = null,Object? commentCount = null,Object? authorType = null,Object? authorId = freezed,Object? postedByUid = freezed,Object? latestComment = freezed,}) {
...
switch (_that) {
case _SpecialModel() when $default != null:
return $default(_that.id,_that.venueId,_that.venueName,_that.title,_that.description,_that.imageUrl,_that.postedAt,_that.startTime,_that.endTime,_that.latitude,_that.longitude,_that.tags,_that.recurrence,_that.recurrenceRule,_that.isTemplate,_that.templateId,_that.isCancelled,_that.archivedAt,_that.isStarred,_that.unstarredAt,_that.reactionUserIds,_that.interestedUserIds,_that.commentCount,_that.authorType,_that.authorId,_that.postedByUid,_that.latestComment);case _:
  return orElse();
...
class _SpecialModel extends SpecialModel {
  const _SpecialModel({required this.id, required this.venueId, required this.venueName, required this.title, required this.description, required this.imageUrl, required this.postedAt, this.startTime, this.endTime, this.latitude, this.longitude, final  List<String> tags = const [], this.recurrence = 'none', this.recurrenceRule, this.isTemplate = false, this.templateId, this.isCancelled = false, this.archivedAt, this.isStarred = false, this.unstarredAt, final  List<String> reactionUserIds = const [], final  List<String> interestedUserIds = const [], this.commentCount = 0, this.authorType = 'venue', this.authorId, this.postedByUid, this.latestComment}): _tags = tags,_reactionUserIds = reactionUserIds,_interestedUserIds = interestedUserIds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,venueId,venueName,title,description,imageUrl,postedAt,startTime,endTime,latitude,longitude,const DeepCollectionEquality().hash(_tags),recurrence,recurrenceRule,isTemplate,templateId,isCancelled,archivedAt,isStarred,unstarredAt,const DeepCollectionEquality().hash(_reactionUserIds),const DeepCollectionEquality().hash(_interestedUserIds),commentCount,authorType,authorId,postedByUid,latestComment]);
