...
mixin _$BingoHallModel {
 ...
 String get id; String get name; String get beaconUuid; double get latitude; double get longitude; bool get isActive; String? get street; String? get city; String? get state; String? get zipCode; String? get phone; String? get websiteUrl; String? get description; String? get logoUrl; String? get bannerUrl;// Geohashing for scalable search
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,beaconUuid,latitude,longitude,isActive,street,city,state,zipCode,phone,websiteUrl,description,logoUrl,bannerUrl,geoHash,followBonus);

@override
String toString() {
  return 'BingoHallModel(id: $id, name: $name, beaconUuid: $beaconUuid, latitude: $latitude, longitude: $longitude, isActive: $isActive, street: $street, city: $city, state: $state, zipCode: $zipCode, phone: $phone, websiteUrl: $websiteUrl, description: $description, logoUrl: $logoUrl, bannerUrl: $bannerUrl, geoHash: $geoHash, followBonus: $followBonus)';
}
...
@useResult
$Res call({
 String id, String name, String beaconUuid, double latitude, double longitude, bool isActive, String? street, String? city, String? state, String? zipCode, String? phone, String? websiteUrl, String? description, String? logoUrl, String? bannerUrl, String? geoHash, double followBonus
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String beaconUuid,  double latitude,  double longitude,  bool isActive,  String? street,  String? city,  String? state,  String? zipCode,  String? phone,  String? websiteUrl,  String? description,  String? logoUrl,  String? bannerUrl,  String? geoHash,  double followBonus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BingoHallModel() when $default != null:
return $default(_that.id,_that.name,_that.beaconUuid,_that.latitude,_that.longitude,_that.isActive,_that.street,_that.city,_that.state,_that.zipCode,_that.phone,_that.websiteUrl,_that.description,_that.logoUrl,_that.bannerUrl,_that.geoHash,_that.followBonus);case _:
  return orElse();
...
class _BingoHallModel extends BingoHallModel {
  const _BingoHallModel({required this.id, required this.name, required this.beaconUuid, required this.latitude, required this.longitude, required this.isActive, this.street, this.city, this.state, this.zipCode, this.phone, this.websiteUrl, this.description, this.logoUrl, this.bannerUrl, this.geoHash, this.followBonus = 0.0}): super._();
