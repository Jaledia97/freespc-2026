...
mixin _$BingoHallModel {
 ...
 String get id; String get name; String get beaconUuid; double get latitude; double get longitude; bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,beaconUuid,latitude,longitude,isActive);

@override
String toString() {
  return 'BingoHallModel(id: $id, name: $name, beaconUuid: $beaconUuid, latitude: $latitude, longitude: $longitude, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String name, String beaconUuid, double latitude, double longitude, bool isActive
});
...
/// Create a copy of BingoHallModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? beaconUuid = null,Object? latitude = null,Object? longitude = null,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String beaconUuid,  double latitude,  double longitude,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BingoHallModel() when $default != null:
return $default(_that.id,_that.name,_that.beaconUuid,_that.latitude,_that.longitude,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String beaconUuid,  double latitude,  double longitude,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _BingoHallModel():
return $default(_that.id,_that.name,_that.beaconUuid,_that.latitude,_that.longitude,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String beaconUuid,  double latitude,  double longitude,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _BingoHallModel() when $default != null:
return $default(_that.id,_that.name,_that.beaconUuid,_that.latitude,_that.longitude,_that.isActive);case _:
  return null;
...
class _BingoHallModel implements BingoHallModel {
  const _BingoHallModel({required this.id, required this.name, required this.beaconUuid, required this.latitude, required this.longitude, required this.isActive});
...
/// Create a copy of BingoHallModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? beaconUuid = null,Object? latitude = null,Object? longitude = null,Object? isActive = null,}) {
