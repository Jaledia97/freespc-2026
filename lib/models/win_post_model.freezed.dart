...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,userId,userName,userProfilePicture,hallId,hallName,winAmount,imageUrl,createdAt,const DeepCollectionEquality().hash(reactionUserIds),const DeepCollectionEquality().hash(interestedUserIds),commentCount,authorType,authorId,postedByUid,latestComment);
...
switch (_that) {
case _WinPostModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.userId,_that.userName,_that.userProfilePicture,_that.hallId,_that.hallName,_that.winAmount,_that.imageUrl,_that.createdAt,_that.reactionUserIds,_that.interestedUserIds,_that.commentCount,_that.authorType,_that.authorId,_that.postedByUid,_that.latestComment);case _:
  return orElse();
...
class _WinPostModel implements WinPostModel {
  const _WinPostModel({required this.id, required this.title, this.description = '', required this.userId, required this.userName, this.userProfilePicture, required this.hallId, required this.hallName, required this.winAmount, this.imageUrl, required this.createdAt, final  List<String> reactionUserIds = const [], final  List<String> interestedUserIds = const [], this.commentCount = 0, this.authorType = 'user', this.authorId, this.postedByUid, this.latestComment}): _reactionUserIds = reactionUserIds,_interestedUserIds = interestedUserIds;
