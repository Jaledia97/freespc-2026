...
mixin _$WinPostModel {
 ...
 String get id; String get title; String get description; String get userId; String get userName; String? get userProfilePicture; String get hallId; String get hallName; double get winAmount; String? get imageUrl; DateTime get createdAt; List<String> get reactionUserIds; List<String> get interestedUserIds; int get commentCount; String? get latestComment;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,userId,userName,userProfilePicture,hallId,hallName,winAmount,imageUrl,createdAt,const DeepCollectionEquality().hash(reactionUserIds),const DeepCollectionEquality().hash(interestedUserIds),commentCount,latestComment);

@override
String toString() {
  return 'WinPostModel(id: $id, title: $title, description: $description, userId: $userId, userName: $userName, userProfilePicture: $userProfilePicture, hallId: $hallId, hallName: $hallName, winAmount: $winAmount, imageUrl: $imageUrl, createdAt: $createdAt, reactionUserIds: $reactionUserIds, interestedUserIds: $interestedUserIds, commentCount: $commentCount, latestComment: $latestComment)';
}
...
@useResult
$Res call({
 String id, String title, String description, String userId, String userName, String? userProfilePicture, String hallId, String hallName, double winAmount, String? imageUrl, DateTime createdAt, List<String> reactionUserIds, List<String> interestedUserIds, int commentCount, String? latestComment
});
...
/// Create a copy of WinPostModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? userId = null,Object? userName = null,Object? userProfilePicture = freezed,Object? hallId = null,Object? hallName = null,Object? winAmount = null,Object? imageUrl = freezed,Object? createdAt = null,Object? reactionUserIds = null,Object? interestedUserIds = null,Object? commentCount = null,Object? latestComment = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String description,  String userId,  String userName,  String? userProfilePicture,  String hallId,  String hallName,  double winAmount,  String? imageUrl,  DateTime createdAt,  List<String> reactionUserIds,  List<String> interestedUserIds,  int commentCount,  String? latestComment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WinPostModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.userId,_that.userName,_that.userProfilePicture,_that.hallId,_that.hallName,_that.winAmount,_that.imageUrl,_that.createdAt,_that.reactionUserIds,_that.interestedUserIds,_that.commentCount,_that.latestComment);case _:
  return orElse();
...
class _WinPostModel implements WinPostModel {
  const _WinPostModel({required this.id, required this.title, this.description = '', required this.userId, required this.userName, this.userProfilePicture, required this.hallId, required this.hallName, required this.winAmount, this.imageUrl, required this.createdAt, final  List<String> reactionUserIds = const [], final  List<String> interestedUserIds = const [], this.commentCount = 0, this.latestComment}): _reactionUserIds = reactionUserIds,_interestedUserIds = interestedUserIds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,userId,userName,userProfilePicture,hallId,hallName,winAmount,imageUrl,createdAt,const DeepCollectionEquality().hash(_reactionUserIds),const DeepCollectionEquality().hash(_interestedUserIds),commentCount,latestComment);
...
/// Create a copy of WinPostModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? userId = null,Object? userName = null,Object? userProfilePicture = freezed,Object? hallId = null,Object? hallName = null,Object? winAmount = null,Object? imageUrl = freezed,Object? createdAt = null,Object? reactionUserIds = null,Object? interestedUserIds = null,Object? commentCount = null,Object? latestComment = freezed,}) {
