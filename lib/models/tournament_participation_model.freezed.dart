...
mixin _$TournamentParticipationModel {
 ...
 String get id; String get tournamentId; String get title; String get venueId;// Added field
 String get venueName;// Kept for fallback
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,tournamentId,title,venueId,venueName,currentPlacement,status,lastUpdated);

@override
String toString() {
  return 'TournamentParticipationModel(id: $id, tournamentId: $tournamentId, title: $title, venueId: $venueId, venueName: $venueName, currentPlacement: $currentPlacement, status: $status, lastUpdated: $lastUpdated)';
}
...
@useResult
$Res call({
 String id, String tournamentId, String title, String venueId, String venueName, String currentPlacement, String status, DateTime lastUpdated
});
...
/// Create a copy of TournamentParticipationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tournamentId = null,Object? title = null,Object? venueId = null,Object? venueName = null,Object? currentPlacement = null,Object? status = null,Object? lastUpdated = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String tournamentId,  String title,  String venueId,  String venueName,  String currentPlacement,  String status,  DateTime lastUpdated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TournamentParticipationModel() when $default != null:
return $default(_that.id,_that.tournamentId,_that.title,_that.venueId,_that.venueName,_that.currentPlacement,_that.status,_that.lastUpdated);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String tournamentId,  String title,  String venueId,  String venueName,  String currentPlacement,  String status,  DateTime lastUpdated)  $default,) {final _that = this;
switch (_that) {
case _TournamentParticipationModel():
return $default(_that.id,_that.tournamentId,_that.title,_that.venueId,_that.venueName,_that.currentPlacement,_that.status,_that.lastUpdated);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String tournamentId,  String title,  String venueId,  String venueName,  String currentPlacement,  String status,  DateTime lastUpdated)?  $default,) {final _that = this;
switch (_that) {
case _TournamentParticipationModel() when $default != null:
return $default(_that.id,_that.tournamentId,_that.title,_that.venueId,_that.venueName,_that.currentPlacement,_that.status,_that.lastUpdated);case _:
  return null;
...
class _TournamentParticipationModel implements TournamentParticipationModel {
  const _TournamentParticipationModel({required this.id, required this.tournamentId, required this.title, required this.venueId, required this.venueName, required this.currentPlacement, required this.status, required this.lastUpdated});
...
/// Create a copy of TournamentParticipationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? tournamentId = null,Object? title = null,Object? venueId = null,Object? venueName = null,Object? currentPlacement = null,Object? status = null,Object? lastUpdated = null,}) {
