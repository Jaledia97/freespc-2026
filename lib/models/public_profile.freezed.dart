...
mixin _$PublicProfile {
 ...
 String get uid; String get username; String get firstName; String get lastName; String? get photoUrl; String? get bio; int get points;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,username,firstName,lastName,photoUrl,bio,points);

@override
String toString() {
  return 'PublicProfile(uid: $uid, username: $username, firstName: $firstName, lastName: $lastName, photoUrl: $photoUrl, bio: $bio, points: $points)';
}
...
@useResult
$Res call({
 String uid, String username, String firstName, String lastName, String? photoUrl, String? bio, int points
});
...
/// Create a copy of PublicProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? username = null,Object? firstName = null,Object? lastName = null,Object? photoUrl = freezed,Object? bio = freezed,Object? points = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String username,  String firstName,  String lastName,  String? photoUrl,  String? bio,  int points)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PublicProfile() when $default != null:
return $default(_that.uid,_that.username,_that.firstName,_that.lastName,_that.photoUrl,_that.bio,_that.points);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String username,  String firstName,  String lastName,  String? photoUrl,  String? bio,  int points)  $default,) {final _that = this;
switch (_that) {
case _PublicProfile():
return $default(_that.uid,_that.username,_that.firstName,_that.lastName,_that.photoUrl,_that.bio,_that.points);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String username,  String firstName,  String lastName,  String? photoUrl,  String? bio,  int points)?  $default,) {final _that = this;
switch (_that) {
case _PublicProfile() when $default != null:
return $default(_that.uid,_that.username,_that.firstName,_that.lastName,_that.photoUrl,_that.bio,_that.points);case _:
  return null;
...
class _PublicProfile implements PublicProfile {
  const _PublicProfile({required this.uid, required this.username, required this.firstName, required this.lastName, this.photoUrl, this.bio, this.points = 0});
...
/// Create a copy of PublicProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? username = null,Object? firstName = null,Object? lastName = null,Object? photoUrl = freezed,Object? bio = freezed,Object? points = null,}) {
