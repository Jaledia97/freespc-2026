...
class _MyPhotoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color statusColor = isPersonal
        ? Colors.blue
        : (isLive ? Colors.green : (isPending ? Colors.orange : Colors.red));
    String statusText = isPersonal
        ? "PERSONAL"
        : (isLive ? "LIVE" : (isPending ? "PENDING" : "DECLINED"));
    IconData statusIcon = isPersonal
        ? Icons.person
        : (isLive
              ? Icons.check_circle
