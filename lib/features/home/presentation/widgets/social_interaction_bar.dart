...
class SocialInteractionBar extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SocialInteractionBar> createState() => _SocialInteractionBarState();
}
...
class _SocialInteractionBarState extends ConsumerState<SocialInteractionBar> {
          ...
          return GestureDetector(
            ...
            child: Scaffold(
              ...
              body: Stack(
                children: [
                  Positioned(
                    left: (position.dx - 40).clamp(16.0, MediaQuery.of(context).size.width - 200.0), 
  ...
  Widget _reactionIcon(String emoji, String label, BuildContext parentContext) {
    return GestureDetector(
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Reacted with $emoji $label")));
  ...
  Future<void> _handleInteractionSync(String field, bool isAdding) async {
     ...
     await ref.read(hallRepositoryProvider).toggleInteraction(
       collectionName, docId, field, currentUser.uid, isAdding
     );
  }
  ...
  void _handleRsvp(bool currentlyRsvpd) {
     ...
     ScaffoldMessenger.of(context).showSnackBar(
       SnackBar(content: Text(currentlyRsvpd ? "RSVP Removed." : "RSVP'd! Added to your schedule."))
     );
  ...
  void _handleComment() {
     ...
     final currentUser = ref.read(authStateChangesProvider).value;
     if (currentUser == null) {
       ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Must be logged in to comment.")));
       return;
     }
  ...
  void _handleShare() {
      ...
      Share.share("Check out $titleText!\n\n$descText\n\nJoin me on FreeSpc today!");
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bool dbIsHyped = currentUser != null && reactions.contains(currentUser.uid);
          ...
          Row(
            children: [
              ...
              GestureDetector(
                ...
                onLongPressStart: (details) => _showReactionsOverlay(context, details.globalPosition),
                child: AnimatedContainer(
                      duration: const Duration(milliseconds: 200),
                      child: Icon(
                        isHyped ? Icons.local_fire_department : Icons.local_fire_department_outlined,
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  final dbIsRsvpd = currentUser != null && interestedUserIds.contains(currentUser.uid);
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isRsvpd ? Colors.blueAccent.withOpacity(0.2) : Colors.white.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(color: isRsvpd ? Colors.blueAccent : Colors.white24),
                      ),
                      child: Text(
             ...
             GestureDetector(
               ...
               child: Padding(
                 ...
                 child: Builder(
                   builder: (context) {
                     try {
                        final data = jsonDecode(latestComment) as Map<String, dynamic>;
                        return Container(
                          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: data['authorAvatarUrl'] != null && data['authorAvatarUrl'].toString().isNotEmpty 
                                    ? NetworkImage(data['authorAvatarUrl']) 
                                    : null,
                                child: (data['authorAvatarUrl'] == null || data['authorAvatarUrl'].toString().isEmpty) 
