...
class EditStoreItemScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditStoreItemScreen> createState() =>
      _EditStoreItemScreenState();
}
...
class _EditStoreItemScreenState extends ConsumerState<EditStoreItemScreen> {
  ...
  void initState() {
    ...
    _perCustomerLimitController = TextEditingController(
      text: widget.existingItem?.perCustomerLimit?.toString() ?? '',
    );
    _dailyLimitController = TextEditingController(
      text: widget.existingItem?.dailyLimit?.toString() ?? '',
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.existingItem == null ? "New Store Item" : "Edit Item",
        ),
        backgroundColor: Colors.transparent,
        elevation: 0,
        actions: [
                      ...
                      child: InputDecorator(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            value: categoriesList.contains(_category)
                                ? _category
                                : null,
