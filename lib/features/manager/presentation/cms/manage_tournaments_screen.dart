...
class ManageTournamentsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ManageTournamentsScreen> createState() =>
      _ManageTournamentsScreenState();
}

class _ManageTournamentsScreenState
    extends ConsumerState<ManageTournamentsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            icon: Icon(
              _tabController.index == 2 ? Icons.save_as : Icons.emoji_events,
              color: Colors.white,
            ),
          ),
            ...
            data: (tournaments) {
              ...
              for (var t in tournaments) {
                ...
                if (t.recurrenceRule == null ||
                    t.recurrenceRule!.frequency == 'none') {
                  final end =
                      t.endTime ?? t.startTime?.add(const Duration(hours: 4));
