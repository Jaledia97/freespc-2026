...
final raffleManagerRepositoryProvider = Provider(
  (ref) => RaffleManagerRepository(FirebaseFirestore.instance),
);
...
class RaffleManagerRepository {
  ...
  Future<void> drawWinner(String hallId) async {
    ...
    await _firestore.runTransaction((transaction) async {
      ...
      transaction.update(docRef, {'winner': winner, 'status': 'winner_drawn'});
    });
  }
